		...
		<div class="site-content">
			...
			<div class="vertical-tabs-container">
			  <div class="vertical-tabs">
			    ...
			    <a href="javascript:void(0)" class="js-vertical-tab vertical-tab" rel="tab3">Video trailer</a>
			    <a href="javascript:void(0)" class="js-vertical-tab vertical-tab" rel="tab4">Item 4</a>
			  </div>

			  <div class="vertical-tab-content-container">
			    <a href="" class="js-vertical-tab-accordion-heading vertical-tab-accordion-heading is-active" rel="tab1">Das Buch</a>
			    ...
			    <div id="tab2" class="js-vertical-tab-content vertical-tab-content" style="height: inherit; overflow-y: scroll">
			      <p><strong>Es ist ein Rätsel:</strong></p>
			    ...
			    <a href="" class="js-vertical-tab-accordion-heading vertical-tab-accordion-heading" rel="tab3">Video trailer</a>
			    <div id="tab3" class="js-vertical-tab-content vertical-tab-content">
			      <iframe width="640" height="360" src="https://www.youtube.com/embed/f--zqVa0t4c?rel=0" frameborder="0" allowfullscreen></iframe>
			    </div>
